...
summative_assessment_start_prompt_str = """We need to deliver a quality summative assessment for the Subject: "{subject}" and the Topic: "{topic}" and the Learning Outcome: "{learning_outcome}".
...
- Remember we want to conduct the assessment with respect to the learning outcome: {learning_outcome}
...
summative_assessment_evaluation_prompt_str = """We now need to perform a detailed concept-based evaluation of the assessment. Here are the relevant concepts for this Learning Outcome:
{concepts}
...
summative_assessment_evaluation_parse_promp_str = """
...
summative_assessment_start_prompt = PromptTemplate.from_template(
    summative_assessment_start_prompt_str
)
summative_assessment_evaluation_prompt = PromptTemplate.from_template(
    summative_assessment_evaluation_prompt_str
)
summative_assessment_evaluation_parse_prompt = PromptTemplate.from_template(
    summative_assessment_evaluation_parse_promp_str
)

formative_assessment_start_prompt_str = """We need to deliver a quality formative assessment for the Subject: "{subject}" and the Topic: "{topic}" and the Learning Outcome: "{learning_outcome}".
...
Please output the first question to start off the assessment:"""

formative_assessment_evaluation_prompt_str = """We now need to perform a detailed concept-based evaluation of the assessment. Here are the relevant concepts for this Learning Outcome:
{concepts}
...
formative_assessment_evaluation_parse_promp_str = """
{assessment_evaluation}
...
formative_assessment_start_prompt = PromptTemplate.from_template(
    formative_assessment_start_prompt_str
)
formative_assessment_evaluation_prompt = PromptTemplate.from_template(
    formative_assessment_evaluation_prompt_str
)
formative_assessment_evaluation_parse_prompt = PromptTemplate.from_template(
    formative_assessment_evaluation_parse_promp_str
)

assessment_system_prompt = """You are an education expert with decades of experience in this field. You understand the importance of concept-based learning and assessment.
