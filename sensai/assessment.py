...
from .prompts import (
    ...
    assessment_evaluation_parse_prompt,
)


class SensaiAssessment:
    ...
    def start_assessment(self):
        assessment_messages = [
            {
                "role": "user",
                "content": assessment_start_prompt.format(
    ...
    def handle_user_answer(self, assessment_messages):
        ...
        response_message = response["choices"][0]["message"]
        end_assessment = "[END]" in response_message["content"]
        assessment_messages.append(response_message)
    ...
    def evaluate_assessment(self, assessment_messages):
        assessment_messages.append(
            {
                "role": "user",
                "content": assessment_evaluation_prompt.format(
        ...
        eval_response = openai.ChatCompletion.create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": assessment_evaluation_parse_prompt.format(
